    ...
    public static void main(String args[]) {
        ...
        Catalog catalog2 = new Catalog(new Comparator<Catalog.Student>() {
            ...
            public int compare(Catalog.Student o1, Catalog.Student o2) {
                int mediaComparison = Double.compare(o2.media, o1.media);
        ...
        for (Catalog.Student o : catalog) {
            ...
            int r = Double.compare(last.media, o.media) != 0 ? Double.compare(o.media, last.media) : last.name.compareTo(o.name);
